...
export const WEBSITE_URL = process.env.NEXT_PUBLIC_WEBSITE_URL || "https://join.com";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Join.com";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "contact@join.com.";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Join.com, Inc.";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Join";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Join.com";
...
export const CONSOLE_URL = "https://console.cal.com"; // admin@example.com -> ADMINadmin2022!
